 ...
 * and usefully.
 * <p>
 * The main class is {@link com.brightcove.johnny.http.Urls}.
 * <p>
 * <b>Overview</b>
 * <p>
 * This library is organized around the successive parsing of nested structural elements.
 * Given a URL string, {@link com.brightcove.johnny.http.Urls#parse(String)} converts it
 * into a {@link com.brightcove.johnny.http.Url} data structure that may be inspected,
